...
class lab2_1_1_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab2_1_1_2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab2_1_1_2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2_1_1_2")
        ...
        self._freq_range = Range(1, 100000, 1000, 10000, 200)
        ...
        self.iio_pluto_sink_0 = iio.pluto_sink('', int(2400000000), int(samp_rate), int(20000000), 32768, False, -30, '', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_pluto_sink_0.set_params(int(2400000000), int(self.samp_rate), int({bandwidth}), -30, '', True)
...
def main(top_block_cls=lab2_1_1_2, options=None):
