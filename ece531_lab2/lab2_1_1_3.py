...
class lab2_1_1_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab2_1_1_3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab2_1_1_3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2_1_1_3")
...
def main(top_block_cls=lab2_1_1_3, options=None):
