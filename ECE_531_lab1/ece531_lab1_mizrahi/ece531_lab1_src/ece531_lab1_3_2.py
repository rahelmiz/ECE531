...
class ece531_lab1_3_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ece531_lab1_3_2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ece531_lab1_3_2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ece531_lab1_3_2")
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(1e3, 40e3, 1000, 10e3, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 2e3, 1, 0, 0)
...
def main(top_block_cls=ece531_lab1_3_2, options=None):
